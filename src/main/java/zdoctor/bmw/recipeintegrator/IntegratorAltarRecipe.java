...
public class IntegratorAltarRecipe implements IRecipeIntegrator {
	...
	public static Map<String, IRecipe> autoMappedRecipes = IntegratorCraftingRecipe.autoMappedRecipes;
		...
		if (mappedRecipe != null) {
			if (mappedRecipe instanceof ShapedBloodOrbRecipe) {
				...
				locatedStrings.add(new LocatedString(I18n.format("bmw.gui.crafting.shapedorb"), x * 2 + 120, y * 2,
						0xFF000000, false));
				locatedStrings.add(new LocatedString("Tier: " + recipe.getTier(), x * 2 + 120, y * 2 + 10,
						0xFF000000, false));
			} else
