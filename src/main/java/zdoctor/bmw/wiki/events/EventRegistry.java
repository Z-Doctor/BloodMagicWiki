...
public class EventRegistry {
	...
	private static class Events {
		...
		public void pageChanged(PageChangeEvent e) {
			...
			if (unloc.contains(Constants.Mod.MODID.toLowerCase())) {
				if (unloc.contains(".orb.") || unloc.contains("bloodorb"))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/item/bloodorbs";
				else if (unloc.contains(".basecomponent."))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/item/basecomponents";
				else if (unloc.contains(".scribe."))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/item/scribetools";
				else if (unloc.contains("activationcrystal"))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/item/activationcrystal";
				else if (unloc.contains(".slate.") || unloc.contains(".sigil."))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/item/sigils";
				else if (unloc.contains(".bound."))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/item/bound";
				else if (unloc.contains(".focus.") || unloc.contains("teleposer"))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/item/foci";
				else if (unloc.contains(".livingarmour.") || unloc.contains("upgradetome")
						|| unloc.contains("downgradetome") || unloc.contains("upgradettrainer"))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/item/livingarmour";
				else if (unloc.contains(".sentientarmour."))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/item/sentientarmour";
				else if (unloc.contains("inversionpillar"))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/block/inversionpillar";
				else if (unloc.contains("/crystal."))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/block/crystal";
				else if (unloc.contains("stone.ritual") || unloc.contains(".ritualstone."))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/block/ritualstones";
				else if (unloc.contains("rune"))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/block/runes";
				else if (unloc.contains("demoncrystal"))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/block/demoncrystals";
				else if (unloc.contains("routing"))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/block/routing";
				else if (unloc.contains("bloodstone"))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/block/bloodstonebrick";
				else if (unloc.contains(".path."))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/block/paths";
				else if (unloc.contains(".mimic."))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/block/mimics";
				else if (unloc.matches("(.*)bricks[0-9](.*)") || unloc.matches("(.*)wall[0-9](.*)")
						|| unloc.matches("(.*)stairs[0-9](.*)") || unloc.matches("(.*)pillar[0-9](.*)")
						|| unloc.contains("extras"))
					e.currentFile = ModMain.MODID.toLowerCase() + ":bloodmagic/block/willblocks";
				else {
					 e.currentFile = e.currentFile.replaceAll("\\.", "/");
					// e.currentFile = e.currentFile.replaceAll("block/" +
					// Constants.Mod.MODID, Constants.Mod.MODID.toLowerCase() +
					// "/block");
		...
		@SubscribeEvent
		public void craftingRetrievalEvent(CraftingRetrievalEvent e) {
		}
