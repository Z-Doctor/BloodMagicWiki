...
import tweaked.igwmod.api.PageChangeEvent;
import tweaked.igwmod.api.WikiRegistry;
import tweaked.igwmod.gui.tabs.IWikiTab;
import tweaked.igwmod.lib.IGWLog;
import tweaked.igwmod.lib.Textures;
...
//		System.out.println("File: " + file);
	...
	protected void keyTyped(char par1, int par2) throws IOException {
		if (searchField.textboxKeyTyped(par1, par2)) {
			...
			if (IGWClientProxy.openInterfaceKey.getKeyCode() == par2) {
	...
	private void drawTooltips(int x, int y) {
		...
		if (hasMultipleTabPages() && x < 33 + guiLeft && x >= 1 + guiLeft && y >= 214 + guiTop && y <= 236 + guiTop) {
			drawHoveringText(Arrays.asList(new String[] { I18n.format("igwmod.tooltip.tabPageBrowse.next"),
					I18n.format("igwmod.tooltip.tabPageBrowse.previous") }), x - guiLeft, y - guiTop);
		}
		/*
...
//					}
	 ...
	 * class,
	 * https://github.com/pahimar/Equivalent-Exchange-3/blob/master/src/main/
	 * java/com/pahimar/ee3/client/renderer/RenderUtils.java
	 * 
	 * @param fontRenderer
	 * @param stack
	 * @param x
